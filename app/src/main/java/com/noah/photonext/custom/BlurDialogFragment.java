...
import com.noah.photonext.util.Blur;
...
public class BlurDialogFragment extends DialogFragment {
    ...
    public LinearLayout pick_photo_ll;
    ...
    public void fadeIn(final FragmentActivity activity, final View.OnClickListener on) {
        ...
        new AsyncTask<Void, Void, Drawable>() {
            ...
            protected Drawable doInBackground(Void... params) {
                BlurDialogFragment.this.onclick = on;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.dialog_pick_top_photo);
        pick_photo_ll = (LinearLayout) dialog.findViewById(R.id.dialog_pick_top_photo);

        window.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        window.setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        window.setBackgroundDrawable(backgroundDrawable);

        pick_photo_ll.setOnClickListener(onclick);
        return dialog;
    }
