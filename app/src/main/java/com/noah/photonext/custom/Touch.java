...
//                Log.e("cxz", "down" + view.getWidth() + " " + view.getHeight());
                ...
                currentMode = DRAG;
                context.showHideBorder(view.getId());
                break;
...
//                    Log.e("cxz","___"+temp2[2]+" "+deltaX+ " "+ temp2[5] +" "+deltaY);
//                    if (temp2[2] +deltaX >= 0 || temp2[2]+deltaX<= (actW-canvasWidth)) {
//                        temp2[2] = 0;
//                        temp2[5] += deltaY;
//                        matrix.setValues(temp2);
//                        if(temp2[5]+deltaY>=0) {
//                            temp2[2]=temp2[5]=0;
//                            matrix.setValues(temp2);
//                        }
//                        break;
//                    }
//                    if(temp2[5]+deltaY>=0 || temp2[5]+deltaY<= (actH-canvasHeight)){
//                        temp2[5] = 0;
//                        temp2[2]+= deltaX;
//                        matrix.setValues(temp2);
//                        break;
